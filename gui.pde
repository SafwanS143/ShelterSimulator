...
public void createGUI(){
  ...
  Material.setLocalColorScheme(GCScheme.GOLD_SCHEME);
  ...
  shelterType.setLocalColorScheme(GCScheme.RED_SCHEME);
  ...
  temperature.setLocalColorScheme(GCScheme.GREEN_SCHEME);
  ...
  naturalDisaster.setLocalColorScheme(GCScheme.CYAN_SCHEME);
  ...
  disasterSeverity.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
